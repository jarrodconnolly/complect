  ...
  _transform (token, encoding, callback) {
    ...
    switch (this.#state) {
      ...
      case ASTState.asStatement: {
        ...
        const binaryExpresssion = t.binaryExpression(operatorToken.value, left, right);
        this._pushStatement(binaryExpresssion);
      ...
      case ASTState.assignmentExpression: {
        ...
        const assignmentExpression = t.assignmentExpression('=', identifier, binaryExpresssion);

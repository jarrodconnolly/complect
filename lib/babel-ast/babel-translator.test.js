...
describe('BabelTranslator', () => {
    ...
    const ir = new Program(
      [
        new VariableDeclaration(
          'x',
          new NumericLiteral(5, { start: { line: 1, column: 1 }, end: { line: 1, column: 1 } }),
  ...
  it('translates variable declaration with string', () => {
    const ir = new Program(
      [
        new VariableDeclaration(
          'msg',
          new StringLiteral('hello', { start: { line: 1, column: 1 }, end: { line: 1, column: 1 } }),
          { start: { line: 1, column: 1 }, end: { line: 1, column: 1 } },
        ),
      ],
      null,
  ...
  it('translates print statement', () => {
    const ir = new Program(
      [
        new PrintStatement(new Identifier('x', { start: { line: 1, column: 1 }, end: { line: 1, column: 1 } }), {
    ...
    const ir = new Program(
      [
        ...
        new WhileStatement(
          ...
          [
            new PrintStatement(new Identifier('a', { start: { line: 1, column: 1 }, end: { line: 1, column: 1 } }), {
              start: { line: 1, column: 1 },
              end: { line: 1, column: 1 },
            }),
            new AssignmentExpression(
  ...
  it('translates call statement with result', () => {
    const ir = new Program(
      [
        ...
        new CallStatement(
          'double',
          [new Identifier('x', { start: { line: 1, column: 13 }, end: { line: 1, column: 13 } })],
          'result',
          { start: { line: 1, column: 1 }, end: { line: 1, column: 15 } },
        ),
      ],
      null,
    );
  ...
  it('translates call statement void', () => {
    const ir = new Program(
      [
        new CallStatement(
          'print',
          [new StringLiteral('hello', { start: { line: 1, column: 12 }, end: { line: 1, column: 18 } })],
          null,

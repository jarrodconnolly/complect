...
export class LLVMTranslator {
  ...
  translate(ir) {
    ...
    // Collect function signatures from call sites
  ...
  collectFunctionSignatures(statements) {
    for (const stmt of statements) {
      if (stmt instanceof CallStatement) {
        ...
        // Recursively collect signatures from function bodies
  ...
  translateFunctionDeclaration(stmt) {
    ...
    // If no return statement, add a default return (though our parser requires returns)

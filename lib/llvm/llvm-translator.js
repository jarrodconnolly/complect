...
export class LLVMTranslator {
  ...
  translate(ir) {
    ...
    this.window = new llvm.GlobalVariable(this.module, this.builder.getInt8PtrTy(), false, llvm.GlobalValue.LinkageTypes.CommonLinkage, llvm.ConstantPointerNull.get(this.builder.getInt8PtrTy()), "window");
    this.renderer = new llvm.GlobalVariable(this.module, this.builder.getInt8PtrTy(), false, llvm.GlobalValue.LinkageTypes.CommonLinkage, llvm.ConstantPointerNull.get(this.builder.getInt8PtrTy()), "renderer");
  ...
  declareRuntimeFunctions() {
    ...
    const sdlCreateWindowType = llvm.FunctionType.get(this.builder.getInt8PtrTy(), [this.builder.getInt8PtrTy(), this.builder.getInt32Ty(), this.builder.getInt32Ty(), this.builder.getInt32Ty(), this.builder.getInt32Ty(), this.builder.getInt32Ty()], false);
    ...
    const createRendererType = llvm.FunctionType.get(this.builder.getInt8PtrTy(), [this.builder.getInt8PtrTy(), this.builder.getInt32Ty(), this.builder.getInt32Ty()], false);
    this.module.getOrInsertFunction('SDL_CreateRenderer', createRendererType);

    const setDrawColorType = llvm.FunctionType.get(this.builder.getInt32Ty(), [this.builder.getInt8PtrTy(), this.builder.getInt8Ty(), this.builder.getInt8Ty(), this.builder.getInt8Ty(), this.builder.getInt8Ty()], false);
    this.module.getOrInsertFunction('SDL_SetRenderDrawColor', setDrawColorType);

    const drawPointType = llvm.FunctionType.get(this.builder.getInt32Ty(), [this.builder.getInt8PtrTy(), this.builder.getInt32Ty(), this.builder.getInt32Ty()], false);
    ...
    const renderDrawLineType = llvm.FunctionType.get(this.builder.getInt32Ty(), [this.builder.getInt8PtrTy(), this.builder.getInt32Ty(), this.builder.getInt32Ty(), this.builder.getInt32Ty(), this.builder.getInt32Ty()], false);
  ...
  translateStatement(stmt) {
    if (stmt instanceof VariableDeclaration) {
      ...
      const window = this.builder.CreateCall(sdlCreateWindowFunc, [title, this.builder.getInt32(-1), this.builder.getInt32(-1), width, height, this.builder.getInt32(0)]);
      if (!this.window) {
        this.window = new llvm.GlobalVariable(this.module, this.builder.getInt8PtrTy(), false, llvm.GlobalValue.LinkageTypes.CommonLinkage, llvm.ConstantPointerNull.get(this.builder.getInt8PtrTy()), "window");
      }
      ...
      const typePtr = this.builder.CreateGEP(this.eventType, eventPtr, [this.builder.getInt32(0), this.builder.getInt32(0)], "typePtr");
      ...
      if (!this.window) {
        this.window = new llvm.GlobalVariable(this.module, this.builder.getInt8PtrTy(), false, llvm.GlobalValue.LinkageTypes.InternalLinkage, null, "window");
      }
      const createRendererFunc = this.module.getFunction('SDL_CreateRenderer');
      const renderer = this.builder.CreateCall(createRendererFunc, [this.builder.CreateLoad(this.builder.getInt8PtrTy(), this.window), this.builder.getInt32(-1), this.builder.getInt32(0)]);
      if (!this.renderer) {
        this.renderer = new llvm.GlobalVariable(this.module, this.builder.getInt8PtrTy(), false, llvm.GlobalValue.LinkageTypes.CommonLinkage, llvm.ConstantPointerNull.get(this.builder.getInt8PtrTy()), "renderer");
      }
      ...
      this.builder.CreateCall(setColorFunc, [this.builder.CreateLoad(this.builder.getInt8PtrTy(), this.renderer), r, g, b, this.builder.getInt8(255)]);
      ...
      this.builder.CreateCall(drawPointFunc, [this.builder.CreateLoad(this.builder.getInt8PtrTy(), this.renderer), x, y]);
      ...
      this.builder.CreateCall(drawLineFunc, [this.builder.CreateLoad(this.builder.getInt8PtrTy(), this.renderer), x1, y1, x2, y2]);
  ...
  translateExpression(expr) {
    if (expr instanceof Identifier) {
      ...
      const piOver180 = llvm.ConstantFP.get(this.builder.getDoubleTy(), 3.141592653589793 / 180.0);
  ...
  translateBinaryExpression(expr) {
    ...
    switch (expr.operator) {
      ...
      case '/': {
        const safeDen = this.builder.CreateSelect(this.builder.CreateICmpEQ(right, this.builder.getInt32(0)), this.builder.getInt32(1), right);

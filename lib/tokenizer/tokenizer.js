    ...
    for await (const preprocessingToken of preprocessorGen) {
      switch(preprocessingToken.type) {
        case PreprocessingTokenType.identifier: {
          ...
          yield this._createToken(tokenType, preprocessingToken.value, preprocessingToken.line, preprocessingToken.column);
          break;
        }
        case PreprocessingTokenType.operator: {
          ...
          yield this._createToken(TokenType.operator, preprocessingToken.value, preprocessingToken.line, preprocessingToken.column);
          break;
        }
        ...
        case PreprocessingTokenType.string: {
          const value = preprocessingToken.value
            .replaceAll('\'', '')
            .replaceAll('"', '');

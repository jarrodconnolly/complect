...
import { Program, VariableDeclaration, AssignmentExpression, BinaryExpression, IfStatement, WhileStatement, PrintStatement, FreeStatement, FunctionDeclaration, ReturnStatement, CallStatement, Identifier, NumericLiteral, StringLiteral, SinExpression, CosExpression, UnaryMinusExpression, SDLInitStatement } from "./ir-nodes.js";
...
describe('ASTBuilder', () => {
  ...
  it('sdlInit statement', async () => {
    const tokens = [
      { type: TokenType.keyword, value: 'sdlInit', line: 1, column: 1 }
    ];
